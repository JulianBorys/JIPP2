...
void help()
{
    ...
    cout << "2. Uzytkownik wypelnia kolejne wiersze macierzy liczbami. Kazda powinna byc oddzielona spacja\n";
    ...
    cout << "9. sortRowsInMatrix\n Sortowanie macierzy po wierszach. Wykorzystuje funkcje ""swap"" ""sortRow""\n";
    cout << "---------------------------------------------------------------------------------------------------------------\n";
}
